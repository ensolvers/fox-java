...
public class TemplateUtils {
    /**
     * Takes a html document with placeholders and a map of replacements, and
     * replaces every value for the values sent in the map
     *
     * @param template     The html for the email
     * @param replacements A map containing for every placeholder, what value it
    ...
    /**
     * Validates that every placeholder in the document has been replaced
     * successfully
     *
