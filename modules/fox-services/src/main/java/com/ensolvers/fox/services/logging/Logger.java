...
/**
 * This service class logger avoids the need to structurally declare a Logger instance in every client class definition. <p>
 * Logs in the right category when logging within a polymorphic hierarchy. <p>
 * <p>
 * <p>
 * Information to obtain the right category is obtained from the instance class. <p>
 * Within a static context ClassName.class() should be used. <p>
 * <p>
 * <p>
 * Accessing info and debug categories is efficient and logging attempt is avoided when inactive <p>
 * <p>
 * <p>
 * <code>debug(...)</code>, <code>info(...)</code>, <code>warn(...)</code> and <code>error(...)</code> methods families provide dynamic access
 * to according level categories with or without exception as parameter <p>
 * <p>
 * <p>
 * <code>is[debug|info]Enabled</code> allows testing on level activation <p>
 * <p>
 * <p>
