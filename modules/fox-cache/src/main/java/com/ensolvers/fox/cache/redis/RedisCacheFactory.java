...
public class RedisCacheFactory {
   ...
   * @param <V> Class of the values.
   */
  public <V> RedisListCache<V> getListCache(
      String name,
      int expireTime,
      Class<V> valueClass,
      Function<V, String> customSerializer,
   ...
   * @param <V> Class of the values.
   */
  public <V> RedisSetCache<V> getSetCache(
      String name,
      int expireTime,
      Class<V> valueClass,
      Function<V, String> customSerializer,
   ...
   * @return a new cache.
   */
  private <V, C extends RedisCache<V>> C getCache(
      String name,
      int expireTime,
      Class<V> valueClass,
      Class<C> cacheType,
    ...
    if (!caches.contains(name)) {
      try {
        ...
        throw new CacheInitializationException(
            "There was a problem when initializing cache with name: " + name, e);
      }
    }
