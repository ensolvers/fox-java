...
public class RedisLimitedCache<V> extends RedisListCache<V> {
	...
	/**
	 * Pushes an element to a non-expiring list cache that is clipped to the
	 * maxEntriesPerBlock
	 *
	...
	/**
	 * Pushes a collection of elements to a non-expiring list cache that is clipped
	 * to the maxEntriesPerBlock
	 *
	 * @param key    The key of the collection.
