...
public interface RedisCollection<V> {
     ...
     * 
     * @return A collection with all the elements. IMPORTANT: If the key does not
     *         exists this method will return an empty collection.
     */
    ...
    /**
     * Removed all the occurrences of all the elements passed as parameter from a
     * collection.
     *
     * @param key    The key of the collection.
