...
public class MemcachedBulkCache<T> extends MemcachedCache<T> implements GenericBulkCache<T> {
    ...
    protected MemcachedBulkCache(MemcachedClient memcachedClient, Function<String, T> fetchFunction,
            Function<Collection<String>, Map<String, T>> fetchMultiFunction, String keyPrefix,
        ...
        super(memcachedClient, fetchFunction, keyPrefix, objectTypeFactory, expirationTimeInSeconds, allowNullValues, customSerializer,
                customDeserializer);
        this.fetchMultiFunction = fetchMultiFunction;
    }

    public MemcachedBulkCache(MemcachedClient memcachedClient, Function<String, T> fetchFunction,
            Function<Collection<String>, Map<String, T>> fetchMultiFunction, String keyPrefix, Class<T> objectClass,
        ...
        this(memcachedClient, fetchFunction, fetchMultiFunction, keyPrefix, f -> f.constructType(objectClass), expirationTimeInSeconds,
                allowNullValues, customSerializer, customDeserializer);
    }

    public MemcachedBulkCache(MemcachedClient memcachedClient, Function<String, T> fetchFunction,
            Function<Collection<String>, Map<String, T>> fetchMultiFunction, String keyPrefix,
            Function<TypeFactory, JavaType> objectTypeFactory, int expirationTimeInSeconds, boolean allowNullValues) {
        this(memcachedClient, fetchFunction, fetchMultiFunction, keyPrefix, objectTypeFactory, expirationTimeInSeconds, allowNullValues,
                null, null);
    }
