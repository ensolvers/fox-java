...
/**
 * It Logs logs information for each invocation to target methods, allowing also to trace details of
 * the execution (like time spent). The following (optional) parameters can be provided:
 *
