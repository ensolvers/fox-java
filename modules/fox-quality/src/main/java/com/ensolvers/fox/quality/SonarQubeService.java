...
/**
 * A utils class that allows to interact with SonarQube (mostly for data fetching)
 * via its API
 *
...
public class SonarQubeService {
    ...
    /**
     * Returns the historic values for a particular metric taken from a specific component within a specific
     * time range
    ...
    public SonarQubeMetricHistoryResponse getMetricHistory(String component, String metric, Instant from, Instant to) throws Exception {
        ...
        Request request = new Request.Builder()
                .url(SONAR_API_BASE_PATH + "/measures/search_history?" +
        ...
        SonarQubeMetricHistoryResponse sonarQubeMetricHistoryResponse = this.objectMapper.readValue(stringResponse, SonarQubeMetricHistoryResponse.class);
