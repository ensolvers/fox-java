...
public class SonarQubeService {
  ...
  /**
   * Returns the historic values for a particular metric taken from a specific component within a
   * specific time range
   *
  ...
  public SonarQubeMetricHistoryResponse getMetricHistory (
    ...
    String tokenInBase64 =
        Base64.getEncoder()
            .withoutPadding()
            .encodeToString((this.token + ":").getBytes(StandardCharsets.UTF_8));
    ...
    SonarQubeMetricHistoryResponse sonarQubeMetricHistoryResponse =
        this.objectMapper.readValue(stringResponse, SonarQubeMetricHistoryResponse.class);
