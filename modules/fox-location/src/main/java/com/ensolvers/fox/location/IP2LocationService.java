...
public class IP2LocationService {
  ...
  private long getIpv4AsNumber(String ip) {
    ...
    /*
      IMPROVEMENTS: this is the worst case scenario: a class C address
      a) compute only the network part (first byte for class A, two for class B, three for class C
