...
public class NetworkUtils {
  ...
  public static Boolean isValidIPv6Address(String ip) {
    ...
    // Check that every hexadecimal value of the ip is valid, when reaching a ':' will check if the value is a valid one, if valid, it will also check if the following value is another ':'
